...
! *** Arguments ***
    ...
    REAL(8), INTENT(in) :: coords_l(:)          !< Coordinates of current analysis domain
    INTEGER, INTENT(in) :: locweight         !< Type of localization function
    REAL(8), INTENT(in) :: lradius              !< Localization radius
    REAL(8), INTENT(in) :: sradius              !< Support radius of localization function
...
! *** Arguments ***
    ...
    TYPE(obs_f), INTENT(inout) :: thisobs    !< Data type with full observation
    REAL(8), INTENT(in) :: coords_l(:)          !< Coordinates of current analysis domain (thisobs%ncoord)
    REAL(8), INTENT(in) :: lradius              !< Localization radius in meters

! *** Local variables ***
    INTEGER :: i            ! Counters
    REAL(8) :: ocoord(thisobs%ncoord)  ! Coordinates of observation
...
! *** Arguments ***
    TYPE(obs_l), INTENT(inout) :: thisobs_l  !< Data type with local observation
    TYPE(obs_f), INTENT(inout) :: thisobs    !< Data type with full observation
    REAL(8), INTENT(in) :: coords_l(:)          !< Coordinates of current water column (thisobs%ncoord)
    REAL(8), INTENT(in) :: lradius              !< Localization radius in meters
...
! *** Arguments ***
    TYPE(obs_l), INTENT(inout) :: thisobs_l  !< Data type with local observation
    TYPE(obs_f), INTENT(inout) :: thisobs    !< Data type with full observation
    REAL*8, INTENT(in) :: obs_f_all(:)         !< Full obs. vector of current obs. for all variables
...
! *** Arguments ***
    ...
    REAL(8), INTENT(in)    :: lradius        !< localization radius
    REAL(8), INTENT(in)    :: sradius        !< support radius for weight functions
...
! *** Arguments ***
    TYPE(obs_l), INTENT(inout) :: thisobs_l  !< Data type with local observation
    REAL*8, INTENT(in) :: obs_f_one(:)         !< Full obs. vector of current obs. type (nobs_f_one)
...
! *** Arguments ***
    TYPE(obs_f), INTENT(in) :: thisobs    !< Data type with full observation
    REAL(8), INTENT(in) :: coordsA(:)           !< Coordinates of current analysis domain (ncoord)
    REAL(8), INTENT(in) :: coordsB(:)           !< Coordinates of observation (ncoord)
    REAL, INTENT(out) :: distance2           !< Squared distance
    INTEGER, INTENT(in) :: verbose           ! Control screen output

! *** Local variables ***
    INTEGER :: k                    ! Counters
    REAL(8) :: dists(thisobs%ncoord)   ! Distance vector between analysis point and observation
