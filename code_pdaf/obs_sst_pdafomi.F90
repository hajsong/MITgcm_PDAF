...
!!
  SUBROUTINE init_dim_obs_sst(step, dim_obs)
    ...
    USE mod_assimilation, &
         ONLY: filtertype, local_range, rms_obs 
...
! *********************************************
    ...
    IF (mype_filter==0) &
         WRITE (*,'(8x,a)') 'Assimilate observations - OBS_sst'
...
!    ALLOCATE(ivar_obs_p(dim_obs_p))
    ...
    ivar_obs_p(:) = 1.0 / (rms_obs_sst*rms_obs_sst)
...
! ******************************************************
    ...
    !=== hajoon
    !   print *,'ostate_0:', ostate
       print *, 'before PDAFomi_obs_op_gridpoint'
    ...
    !=== hajoon
       ...
       WRITE (*,*) 'obs_op_sst is running'
    !=== hajoon
    !   print *,'ostate_1:', ostate
       print *, 'after PDAFomi_obs_op_gridpoint'
       print *, 'state_p(299) = ', state_p(299)
    !=== hajoon
    END IF
...
!!
  SUBROUTINE localize_covar_sst(dim_p, dim_obs, HP_p, HPH, coords_p)
...
! *************************************
  ...
  END SUBROUTINE localize_covar_sst
